  ...
  "settings_schema": {
    ...
    "settings": [{
		...
		},
		{
			...
			"type": "number",
			"help_text": "Interval delay in minutes specifying when the auto save should trigger for ecosystem graphs. This setting does nothing if the auto save setting is off. Max value is 30.",
			"default": 5
		},
		{
