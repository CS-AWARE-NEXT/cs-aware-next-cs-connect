...
const items: DocumentationItem[] = [
    {id: 'about-the-platform', name: 'About The Platform', path: 'about', content: Content},
    {id: 'hyperlinking-mechanism', name: 'Hyperlinking Mechanism', path: 'mechanism', content: Content},
];
